...
parser.add_argument("--cuda_device", type=str, default=False, help="CUDA device id(s) to use (e.g., '0' or '0,1').")
parser.add_argument("--cuda_device_ORCA", type=str, default=False, help="CUDA device id(s) to use (e.g., '0' or '0,1').")
