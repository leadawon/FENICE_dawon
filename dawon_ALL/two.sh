...
python fenice_all.py \
  ...
  --result_file ../results/aggre_cnndm_corefv2/fenice_wr0p3_wb0p7_wcc1_wc1_wm1_ww0_k2.json \
  --weight_rouge 0.3 \
  ...
  --result_file ../results/aggre_xsum_corefv2/fenice_wr0p3_wb0p7_wcc1_wc1_wm1_ww0_k2.json \
  --weight_rouge 0.3 \
  --weight_bertscore 0.7 \
  --weight_compare_cont 1.0 \
  --weight_cont 1.0 \
